 ...
 function imprimerSections() {
    ...
    const contenu = document.getElementById("proforma").outerHTML + document.getElementById("facture_definitive").outerHTML + document.getElementById("bon_livraison").outerHTML;
